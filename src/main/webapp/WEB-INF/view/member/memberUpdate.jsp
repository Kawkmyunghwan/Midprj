	...
	<form id="frm" action="memberUpdate.do" method="post">
		...
		<div align="center">
			<table>
				...
				<tr>
					<th>선호직군</th>
					<td><input type="checkbox" id="fav1" name="favorite" value="IT">IT&nbsp;&nbsp;
						<input type="checkbox" id="fav2" name="favorite" value="기획">기획&nbsp;&nbsp;
						<input type="checkbox" id="fav3" name="favorite" value="건축">건축
						<input type="hidden" id="fav0" name="favor"></td>
				</tr>
			</table>
		</div>
