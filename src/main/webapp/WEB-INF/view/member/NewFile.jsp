         ...
         <form id="frm" action="memberJoin.do" onsubmit="return formCheck()"
            ...
            <div>
               <table border="1">
                  <tr>
                     <th width="100">아이디</th>
                     <td width="300"><input type="id" id="memberId" name="memberId" required="required"> &nbsp;&nbsp;
                  ...
                  <tr>
                     <th>이메일</th>
                     <td><input type="email" id="memberEmail" name="memberEmail"
                  ...
                  <tr>
                     ...
                     <input type="checkbox" name="favorite" value="기획">기획
                     <input type="checkbox" name="favorite" value="건축">건축
                     </td>
                  </tr>
               </table>
            </div>
            ...
            <div>
               <input type="submit" value="회원가입">&nbsp;&nbsp; <input
                  ...
                  onclick="formCheck()" value="홈 가기"
                  onclick="location.href='homeCommand.do'">
            </div>
         </form>
      </div>
   </div>
