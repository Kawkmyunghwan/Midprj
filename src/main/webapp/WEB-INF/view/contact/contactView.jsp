...
<body>
   ...
   <form id="frm" method="post">
         ...
         <div>
            ...
            <table border="1" class="card">
               ...
               <tr>
                  ...
                  <td colspan="3">
                     <textarea rows="10" cols="80"  class="form-control" id="isContantsText" style="padding:1px 1px 1px 10px;" readonly="readonly">${contact.infoAnswerContent}</textarea>
                     
                     <textarea rows="10" class="form-control" id="infoAnswerContent" 
                             name="infoAnswerContent" cols="80">${contact.infoAnswerContent}</textarea>
      ...
      <div align="center" style="padding : 10px 40px">
         ...
         <c:if test="${memberName eq contact.infoWriter || memberName eq 'admin'}">
         <button type="button" onclick="contentsShow()" class="genric-btn primary small">수정</button>
         &nbsp;&nbsp;
         <button type="button" onclick="contentsUpdate()" class="genric-btn primary small">수정완료</button>
         &nbsp;&nbsp;
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      var str = `${contact.infoAnswerContent}`;
      if(str != "" || str == null){
         $("#infoAnswerContent").hide();
      }else{
         $("#infoAnswerContent").show();
      }
   })
